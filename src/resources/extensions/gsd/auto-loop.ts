...
export { resolveAgentEnd, resolveAgentEndCancelled, isSessionSwitchInFlight, _hasPendingResolve, _resetPendingResolve, _setActiveSession } from "./auto/resolve.js";
